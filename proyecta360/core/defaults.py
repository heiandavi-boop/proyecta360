...
PROYECTA360_LAC_STRATEGIC_FRAMEWORK: Dict[str, str] = {
    ...
    "expected_results": "MVP funcional de PRUNIN LAC, proyectos piloto cargados, motor interno de analisis operativo, recomendaciones IA-ready, reportes ejecutivos exportables y base de conocimiento del proyecto.",
    ...
    "institutional_context": "PRUNIN LAC se ubica en un entorno de cooperacion, innovacion y gestion de conocimiento donde la evidencia y los reportes son parte central del cumplimiento.",
